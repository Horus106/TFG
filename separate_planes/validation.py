...
def main(test_path, data_path, color_mode, img_shape, depth, cnn, verbose_level, pretrained_model, output, resnet):
    ...
    test = fn.get_images_list(test_df, color_mode, view=args["view"], weights=False)
    test_not_augment = fn.get_images_list(test_df, color_mode, view=args["view"], augment=False, weights=False)
