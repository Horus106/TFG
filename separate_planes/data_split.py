...
pubis_age = pd.read_csv('./separate_planes/dataset.csv')
...
train.to_csv('./separate_planes/train.csv',index=False)
validation = validation.drop(columns=["Range"])
validation.to_csv('./separate_planes/validation.csv',index=False)
test = test.drop(columns=["Range"])
test.to_csv('./separate_planes/test.csv',index=False)
train_val = train_val.drop(columns=["Range","Set"])
train_val.to_csv('./separate_planes/trainval.csv',index=False)
